...
output_dir = '/content/drive/MyDrive/oitsminez-rvc-v2/song_output'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-uvc', '--uvc-function', type=str, default='true', help='Use Ultimate Vocal Remove to separate Vocal and Instrumental from audio')
